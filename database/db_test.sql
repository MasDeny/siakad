...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2017 at 02:12 PM
...
INSERT INTO `berkas` (`id_berkas_kelengkapan`, `khs_semester_1`, `khs_semester_2`, `khs_semester_3`, `khs_semester_4`, `khs_semester_5`, `laporan_proposal`, `kartu_kendali`, `bukti_spp_terakhir`) VALUES
(35, '_E31150678', '_E31150678', '_E31150678', '_E31150678', '_E31150678', '_E31150678', '_E31150678', '_E31150678'),
(36, '1_file_E31150678.png', '2_file_E31150678.png', '3_file_E31150678.png', '4_file_E31150678.png', '5_file_E31150678.png', '6_file_E31150678.pdf', '7_file_E31150678.png', '8_file_E31150678.png');
...
(21, 'E31150678_1', 'E31150678_2', 'E31150678_3', 'E31150678_4', 'E31150678_5', 'E31150678_6', 'E31150678_7', 'E31150678_8', 'E31150678_9', 'E31150678_10', 'E31150678_11'),
(22, 'E31150198_1.pdf', 'E31150198_2.pdf', 'E31150198_3.pdf', 'E31150198_4.pdf', 'E31150198_5.pdf', 'E31150198_6.pdf', 'E31150198_7.pdf', 'E31150198_8.pdf', 'E31150198_9.pdf', 'E31150198_10.pdf', 'E31150198_11.pdf'),
(23, 'E31150000_1.pdf', 'E31150000_2.pdf', 'E31150000_3.pdf', 'E31150000_4.pdf', 'E31150000_5.pdf', 'E31150000_6.pdf', 'E31150000_7.pdf', 'E31150000_8.pdf', 'E31150000_9.pdf', 'E31150000_10.pdf', 'E31150000_11.pdf'),
(24, 'E31150000_1.pdf', 'E31150000_2.pdf', 'E31150000_3.pdf', 'E31150000_4.pdf', 'E31150000_5.pdf', 'E31150000_6.pdf', 'E31150000_7.pdf', 'E31150000_8.pdf', 'E31150000_9.pdf', 'E31150000_10.pdf', 'E31150000_11.pdf'),
(25, 'E31150000_12.pdf', 'E31150000_21.pdf', 'E31150000_31.pdf', 'E31150000_41.pdf', 'E31150000_51.pdf', 'E31150000_61.pdf', 'E31150000_71.pdf', 'E31150000_81.pdf', 'E31150000_91.pdf', 'E31150000_101.pdf', 'E31150000_111.pdf'),
(26, 'E31150000_12.pdf', 'E31150000_21.pdf', 'E31150000_31.pdf', 'E31150000_41.pdf', 'E31150000_51.pdf', 'E31150000_61.pdf', 'E31150000_71.pdf', 'E31150000_81.pdf', 'E31150000_91.pdf', 'E31150000_101.pdf', 'E31150000_111.pdf');
...
(1, 'sistem Inventaris laboratorium berbasis web', 'asd'),
(2, 'Sistem Pakar penentu penyakit tanaman kopi', 'asd'),
(3, 'Aplikasi On-Food berbasis android', 'asd'),
(4, 'Aplikasi penentu gizi atlet berbasis android', 'asd'),
(5, 'Web profil SMA Negeri 1 Tapen', 'asd');
...
(2, 'Aji Seto Arifianto, S.ST., M.T'),
(3, 'Dwi Putro Sarwo S., S.Kom, M.Kom'),
(4, 'Hendra Yufit Riskiawan, S.Kom, M.Cs'),
(5, 'Ika Widiastuti, S.ST,MT');
...
INSERT INTO `jadwal` (`idJadwal`, `jam`, `tanggal`, `ruangan`, `panelis_1`, `panelis_2`, `panelis_3`, `idStatus_Sempro`) VALUES
(3, '05:37', 'Senin, 18 Desember 2017', 'Pasca 2.3', 'Edi Sumanto', 'Heru Santoso', 'rudi setiawan', 7);
...
INSERT INTO `mahasiswa` (`NIM`, `nama_mahasiswa`, `program_studi`, `id_dp1`, `dospem_2`, `id_rumpun`, `judul_TA`, `deskripsi`, `id_mhs`, `id_dokumen`, `status`, `status_mahasiswa`, `keterangan`) VALUES
('E31150000', 'budi', 'mif', 1, 'dp2', 1, 'judul ta', 'desc', 5, 1, '1', 'mahasiswa', '0'),
('E31150198', 'Bagus Azizul Amri', 'Manajemen Informatika', 5, 'Ratis Ayuninghemi ', 2, 'Pencarian Jalur terdekat', 'pencarian jalur dengan metode pencarian BFS', 3, 3, '1', 'mahasiswa', '0'),
('E31150678', 'jjjjjj', 'mif', 3, 'asdasd', 2, 'aaa', 'jaskdjska', 4, 1, '1', 'mahasiswa', '0');
...
CREATE TABLE IF NOT EXISTS `status_sempro` (
  ...
  `berkas_revisi` varchar(200) DEFAULT NULL,
...
INSERT INTO `status_sempro` (`idStatus_Sempro`, `mahasiswa_NIM`, `dokumen_kelengkapan_senpro_iddokumen_kelengkapan_senpro`, `status`, `berkas_revisi`, `status_revisi`) VALUES
(7, 'E31150678', 21, 2, 'E31150678_1.pdf', 1),
(8, 'E31150198', 0, 0, NULL, 0),
(9, 'E31150000', 26, 0, NULL, 0);
...
CREATE TABLE IF NOT EXISTS `status_sidang` (
  ...
  `berkas_id_berkas_kelengkapan` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `status_sidang`
  ADD PRIMARY KEY (`id_statussidang`),
...
--
ALTER TABLE `berkas`
  MODIFY `id_berkas_kelengkapan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `dokumen_kelengkapan_senpro`
--
ALTER TABLE `dokumen_kelengkapan_senpro`
  MODIFY `iddokumen_kelengkapan_senpro` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=27;
--
...
--
ALTER TABLE `dp1`
  MODIFY `id_dp1` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `rumpun`
  MODIFY `id_rumpun` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `status_sempro`
--
ALTER TABLE `status_sempro`
  MODIFY `idStatus_Sempro` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
