...
<body>
  ...
  <ul id="slide-out" class="side-nav">
    ...
    <li><div class="divider"></div></li>
    <li><a href="<?php echo base_url(); ?>index.php/yudisium">Pendaftaran Seminar Proposal</a></li>
    <li><div class="divider"></div></li>
    ...
    <li><div class="divider"></div></li>
    <li><a href="<?php echo base_url(); ?>index.php/admin/getstudytracer">Pendaftaran Tracer Study</a></li>
    <li><div class="divider"></div></li>
    <li><a href="<?php echo base_url(); ?>index.php/admin/getyudisium">Pendaftaran Yudisium</a></li>
    <li><div class="divider"></div></li>
  </ul>
  <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons">menu</i></a>
    ...
    <div class="container">
      <br><br>
      <h3 class="header center">Anda Sudah Mendaftar</h3>

	  <div class="row"><br><br>
      	<div class="col s3"></div>
      	<div class="col s3"><input type="submit" name="submitkhs1" value="Edit" class="btn btn-success"></div>
		<div class="col s3"><input type="submit" name="submitkhs2" value="Simpan" class="btn btn-success"></div>
      </div>
      ...
      <div class="row align-center copyright">
        <div class="col-sm-12">
          <div class="credits">
            ...
            -->
            <a href="">Copyright &copy; 2017 DEVteam_Modul2_PSI</a><a href="https://bootstrapmade.com/">     | Bootstrap Themes</a> <a href="https://bootstrapmade.com/">  by BootstrapMade</a>
          </div>
        </div>
      </div>
    </div>
