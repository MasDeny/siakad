...
<!-- Container Starts -->
    ...
    <?php //<script type="text/javascript" src="<?php echo base_url('assets/js/color-switcher.js');?*>"></script> hilangkan tanda bintang di penutup?>
    ...
    <script type="text/javascript" src="<?php echo base_url('assets/js/Chartjs/Chart.bundle.js');?>"></script>
