...
=            modal lihat            =
==================================-->
<div class="modal fade" id="lihat_sem" tabindex="-1" aria-hidden="true" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="">Data Pendaftaran Seminar Proposal</h4>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control border-input text-center" id="panelis1" disabled>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Panelis 2</label>
                                        <input type="text" class="form-control border-input text-center" id="panelis2" disabled>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Panelis 3</label>
                                        <input type="text" class="form-control border-input text-center" id="panelis3" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
